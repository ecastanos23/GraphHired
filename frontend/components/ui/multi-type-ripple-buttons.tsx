...
const RippleButton: React.FC<RippleButtonProps> = ({
  ...
  if (variant === 'hover') {
    const hoverButtonFinalClassName = [
      'relative isolate overflow-hidden rounded-lg border-none bg-transparent px-4 py-2 text-lg',
      'cursor-pointer',
  ...
  const baseClasses =
    'relative isolate overflow-hidden rounded-lg border-none bg-blue-600 px-4 py-2 text-white transition-all duration-200 hover:opacity-90';
